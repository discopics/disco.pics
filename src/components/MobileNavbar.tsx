      ...
      {isOpen && (
        ...
        >
          <div className="relative">
            <button
              onClick={toggle}
              className="flex p-1 bg-rose-400/20 rounded-md justify-center items-center absolute top-2 left-2"
            >
          ...
          <motion.div className="flex flex-col ml-2 gap-8 items-start">
            <motion.button
          ...
          <motion.div
            ...
            className="flex gap-3 justify-center items-center w-fit rounded-md px-4 py-3 bg-rose-400/10"
          >
            ...
            <div className="flex w-fit flex-col justify-center items-center gap-0">
              {" "}
              <h1 className="text-rose-200 inline text-xl">
                {session?.user.name}
              </h1>
